      ...
      optionsHtml = `
        ...
        <div style="margin-top:20px; padding-top:16px; border-top:1px solid var(--border,#333);">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:14px;">
            ...
            <button class="btn btn-text" style="font-size:12px;padding:4px 8px;height:auto;color:var(--primary);display:flex;align-items:center;gap:4px;" onclick="QuizPage.showUploadFloorplan()">
